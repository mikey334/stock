...
if (logged_in()) {
	header('Location: home_spear.php');
	exit;
...
<body>
    ...
    window.location = "Home_spear.php";
    </script>
    <?php
            } else {
    ?>
    ...
    <div id="adimn" class="login-card">
        <div class="login-titel">Spaer login Page</div>
        <hr>
    <form action="login_spaer.php" method="post">
      ...
      <br>
      <button type="submit" name="btnloginsp"  class="btn_login">SingIn</button>
