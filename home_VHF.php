...
<div class="last_Bincard active"> 
    ...
    foreach ($cur as $bincard){
       echo " <div class='bincard_all'>
           ...
           <div class='bin_card_titel_imgl'><button class='expand'><img src='img/expand_more_FILL0_wght400_GRAD0_opsz48.png' width='40'></button></div>
            </div>
           <br><br>
