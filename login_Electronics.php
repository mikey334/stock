...
if (logged_in()) {
	header('Location: home_electronics.php');
	exit;
...
<body>
    ...
    window.location = "Home_electronics.php";
    </script>
    <?php
            } else {
    ?>
    ...
    <div id="adimn" class="login-card">
        <div class="login-titel">Electronic login Page</div>
        <hr>
    <form action="login_Electronics.php" method="post">
