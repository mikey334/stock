...
<body>
    ...
    <div id="adimn" class="login-card">
        <div class="login-titel">HF login Page</div>
        <hr>
    <form action="login_HF.php" method="post">
      ...
      <br>
      <button type="submit" name="btnloginhf"  class="btn_login">SingIn</button>
