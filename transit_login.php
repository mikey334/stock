...
if (logged_in()) {
	header('Location: Home_Transit.php');
	exit;
...
<body>
    <?php
    if (isset($_POST['btnTransitlogin'])) {
    ...
    window.location = "Home_Transit.php";
    </script>
    <?php
            } else {
    ?>
    ...
    window.location = "transit_login.php";
    </script>
    <?php
            }
        }
    ...
    ?><center>
    <div id="Transit" class="login-card">
        <div class="login-titel">Transit Login Page</div>
        <hr>
    <form action="index.php" method="post">
      ...
      <br>
      <button type="submit" name="btnTransitlogin"  class="btn_login">SingIn</button>
